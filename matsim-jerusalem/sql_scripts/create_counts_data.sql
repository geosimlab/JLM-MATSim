--creating readible counts data

CREATE TABLE IF NOT EXISTS counts_data as
--initial_long - convert data from wide to long
...
from counts),
--direction_hours - manipulating hours strings 
direction_hours as (
...
--directing - making sure direction is right
directing as(
select cid, linkid,
case 
...
--with_type - left joining links for type
with_type as(
