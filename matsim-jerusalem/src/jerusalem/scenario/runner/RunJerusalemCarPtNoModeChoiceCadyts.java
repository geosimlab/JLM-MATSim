 ...
 */
public class RunJerusalemCarPtNoModeChoiceCadyts {
	...
	final public static String INPUT_COUNTS = "E:\\geosimlab\\MATSim-JLM\\MATSim-JLM Input\\counts\\1.counts.xml.gz";
	...
	public static Config createJeruslaemConfig() {
		...
		config.counts().setCountsScaleFactor(1/0.3);
		config.counts().setOutputFormat("all");
		config.counts().setWriteCountsInterval(10);
//		config.counts().setAnalyzedModes(TransportMode.car);
...
//		 config.subtourModeChoice().setConsiderCarAvailability(true);
	...
	private static void addCadyts(Config config, Controler controler) {
        ...
        cadystConfigGroup.setEndTime(20*60*60);
