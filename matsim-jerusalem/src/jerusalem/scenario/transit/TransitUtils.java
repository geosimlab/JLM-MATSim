...
public class TransitUtils {
	 ...
	 * https://github.com/gunnarfloetteroed/java/blob/master/utilities/src/main/java
	 * /floetteroed/utilities/Time.java
	 */
	...
	public static int secFromStr(final String timeStr) {
		if (timeStr.indexOf(":") < 0) {
			...
			final String[] elements = timeStr.split("\\Q" + ":" + "\\E");
			final int h = Integer.parseInt(elements[0]);
			final int m = Integer.parseInt(elements[1]);
			final int s = (elements.length > 2) ? Integer.parseInt(elements[2]) : 0;
